...
export const AuditLogView: React.FC = () => {
  ...
  const getCategoryBadge = (category: AuditCategory) => {
    switch (category) {
      ...
      case 'SYSTEM':
        return <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-slate-100 dark:bg-[#0f1a15] text-slate-700 dark:text-emerald-300/80 border border-slate-200 dark:border-emerald-800/40">Sistem</span>;
      default:
        return <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-slate-100 dark:bg-[#0f1a15] text-slate-700 dark:text-emerald-300/80">{category}</span>;
    }
  };
  ...
  const getSeverityBadge = (severity: AuditSeverity) => {
    switch (severity) {
      ...
      default:
        return (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium bg-slate-50 dark:bg-[#0f1a15]/40 text-slate-600 dark:text-emerald-400/70 border border-slate-100 dark:border-emerald-900/40">
            Info
          </span>
        );
    }
  ...
  const getRoleBadge = (role: string) => {
    switch (role) {
      ...
      case 'GURU':
        return <span className="px-1.5 py-0.5 text-[10px] font-medium rounded bg-slate-100 dark:bg-[#0f1a15] text-slate-700 dark:text-emerald-300/80 border border-slate-200 dark:border-emerald-800/40">Guru</span>;
      default:
        return <span className="px-1.5 py-0.5 text-[10px] font-medium rounded bg-slate-50 dark:bg-[#0f1a15]/30 text-slate-500 dark:text-emerald-400/70">Sistem</span>;
    }
  };
  ...
  return (
    <div className="space-y-5">
      {/* 1. Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-[#121f1a] px-5 py-4 rounded-xl border border-slate-200 dark:border-emerald-900/40 dark:border-emerald-900/40">
        <div>
          <h1 className="text-base font-semibold text-slate-900 dark:text-emerald-50 tracking-tight flex items-center gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 bg-slate-50 dark:bg-[#0f1a15] hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-700 dark:text-emerald-300/80 text-xs font-medium px-3.5 py-2 rounded-lg border border-slate-200 dark:border-emerald-800/40 transition-colors cursor-pointer self-start sm:self-auto"
        >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        <div className="bg-white dark:bg-[#121f1a] p-4 rounded-xl border border-slate-200 dark:border-emerald-900/40 dark:border-emerald-900/40">
          <span className="text-xs text-slate-500 dark:text-emerald-400/70 block">Total Entri</span>
          <p className="text-2xl font-semibold text-slate-900 dark:text-emerald-50 mt-1 font-mono">{totalLogs}</p>
          <span className="text-[11px] text-slate-400 dark:text-emerald-500/60 block mt-1">Audit aktif</span>
        </div>

        <div className="bg-white dark:bg-[#121f1a] p-4 rounded-xl border border-slate-200 dark:border-emerald-900/40 dark:border-emerald-900/40">
          <span className="text-xs text-slate-500 dark:text-emerald-400/70 block">Perubahan Kafa'ah</span>
        ...
        <div className="bg-white dark:bg-[#121f1a] p-4 rounded-xl border border-slate-200 dark:border-emerald-900/40 dark:border-emerald-900/40">
          <span className="text-xs text-slate-500 dark:text-emerald-400/70 block">Aktivitas KBM</span>
        ...
        <div className="bg-white dark:bg-[#121f1a] p-4 rounded-xl border border-slate-200 dark:border-emerald-900/40 dark:border-emerald-900/40">
          <span className="text-xs text-slate-500 dark:text-emerald-400/70 block">Isu Kritis</span>
      ...
      {/* 3. Filters & Search */}
      <div className="bg-white dark:bg-[#121f1a] p-4 rounded-xl border border-slate-200 dark:border-emerald-900/40 dark:border-emerald-900/40 space-y-3">
        <div className="flex flex-col md:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 text-xs bg-slate-50 dark:bg-[#0f1a15] border border-slate-200 dark:border-emerald-800/40 rounded-lg focus:outline-none focus:border-emerald-600 dark:focus:border-emerald-500 text-slate-900 dark:text-emerald-50"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <select
              ...
              className="px-2.5 py-1.5 text-xs bg-slate-50 dark:bg-[#0f1a15] border border-slate-200 dark:border-emerald-800/40 rounded-lg focus:outline-none focus:border-emerald-600 dark:focus:border-emerald-500 text-slate-900 dark:text-emerald-50"
            >
      ...
      {/* 4. Table */}
      <div className="bg-white dark:bg-[#121f1a] rounded-xl border border-slate-200 dark:border-emerald-900/40 dark:border-emerald-900/40 overflow-hidden">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-slate-700 dark:text-emerald-300/80">
              {filteredLogs.length === 0 ? (
                ...
                filteredLogs.map((log) => {
                  ...
                  return (
                    <tr key={log.id} className="hover:bg-slate-50 dark:bg-[#0f1a15]/50 dark:hover:bg-[#162720]/50/30 transition-colors">
                      <td className="py-3 px-4 align-top whitespace-nowrap">
                        <p className="font-medium text-slate-900 dark:text-emerald-50">{formattedTime}</p>
                        <p className="text-[10px] text-slate-400 dark:text-emerald-500/60 font-mono">{formattedDate}</p>
                      </td>

                      <td className="py-3 px-4 align-top">
                        <p className="font-medium text-slate-800 dark:text-emerald-100">{log.userName}</p>
                        <div className="mt-1 flex items-center gap-1">
                          {getRoleBadge(log.userRole)}
                          {log.ipAddress && (
                            <span className="text-[10px] text-slate-400 dark:text-emerald-500/60 font-mono">
                              {log.ipAddress}
                            </span>
                          )}
                        </div>
                      ...
                      <td className="py-3 px-3 align-top">
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-emerald-400/70 font-mono mt-1 font-medium">
                          {log.action}
                        </p>
                      </td>

                      <td className="py-3 px-4 align-top">
                        <p className="text-slate-600 dark:text-emerald-400/70 leading-relaxed max-w-md">{log.details}</p>
                      </td>
