...
export const MasterTeachers: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-emerald-900/40 pb-2.5">
        <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-[#0f1a15] p-1 rounded-lg">
          <button
            id="subtab-profil-guru"
            onClick={() => setActiveSubView('profil_guru')}
            className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all cursor-pointer ${
              activeSubView === 'profil_guru'
                ? 'bg-white dark:bg-[#162720]/50 text-slate-900 dark:text-emerald-50 shadow-2xs font-semibold'
        ...
        <span className="text-xs text-slate-400 dark:text-emerald-500/60 font-mono hidden sm:inline">
        ...
        <div className="space-y-3.5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handleReset}
                className="inline-flex items-center justify-center gap-1.5 bg-white dark:bg-[#121f1a] hover:bg-rose-50 dark:hover:bg-rose-950/20 text-rose-600 dark:text-rose-400 text-xs font-medium px-3 py-1.5 rounded-lg border border-slate-200 dark:border-emerald-900/40 transition-colors cursor-pointer"
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 bg-slate-50 dark:bg-[#0f1a15] hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-700 dark:text-emerald-300/80 text-xs font-medium px-3 py-1.5 rounded-lg border border-slate-200 dark:border-emerald-800/40 transition-colors cursor-pointer"
              >
                <UploadCloud className="w-3.5 h-3.5 text-slate-500 dark:text-emerald-400/70" />
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-slate-700 dark:text-emerald-300/80">
                  {filteredTeachers.map((t, idx) => (
                    <tr key={t.id} className="hover:bg-slate-50 dark:bg-[#0f1a15]/50 dark:hover:bg-[#162720]/50/30 transition-colors">
                      ...
                      <td className="py-2.5 px-4">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <p className="font-medium text-slate-900 dark:text-emerald-50">{t.name || '-'}</p>
                            <p className="text-[11px] text-slate-400 dark:text-emerald-500/60 font-mono">{t.nip || '-'}</p>
                          </div>
                        </div>
                      </td>
                      <td className="py-2.5 px-3 text-slate-700 dark:text-emerald-300/80">
                        {t.position}
                      </td>
                      <td className="py-2.5 px-3">
                        <span className="text-[11px] text-slate-600 dark:text-emerald-400/70 bg-slate-100 dark:bg-[#0f1a15] px-2 py-0.5 rounded">
                          {t.unit}
                        </span>
                      </td>
                      ...
                      <td className="py-2.5 px-3 text-center">
                        <div className="flex items-center justify-center gap-1">
                          <button
                            ...
                            className="p-1 text-slate-400 dark:text-emerald-500/60 hover:text-slate-800 dark:hover:text-slate-200 rounded transition-colors cursor-pointer"
                            title="Edit"
                          >
                          ...
                          <button
                            ...
                            className="p-1 text-slate-400 dark:text-emerald-500/60 hover:text-rose-600 dark:hover:text-rose-400 rounded transition-colors cursor-pointer"
                            title="Hapus"
                          >
