      ...
      <div className="lg:col-span-1 space-y-4">
        <div className="bg-white dark:bg-[#0B2B26] rounded-[16px] border border-slate-200/80 dark:border-[#163832] shadow-xs p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-sm text-slate-900 dark:text-[#DAF1DE]">Presensi Dapur</h3>
            </div>
          </div>
      ...
      <div className="lg:col-span-2">
        <div className="bg-white dark:bg-[#0B2B26] rounded-[16px] border border-slate-200/80 dark:border-[#163832] shadow-xs p-5">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-9 h-9 rounded-xl bg-amber-50 dark:bg-[#163832] text-amber-600 dark:text-[#8EB69B] flex items-center justify-center border border-amber-200/60 dark:border-[#0B2B26] shrink-0">
              <Utensils className="w-4 h-4" />
            </div>
            <div>
              <h3 className="font-bold text-slate-900 dark:text-[#DAF1DE] text-sm">Sajian Menu Konsumsi</h3>
            </div>
          </div>
