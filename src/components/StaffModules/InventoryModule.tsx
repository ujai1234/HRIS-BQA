      ...
      <div className="lg:col-span-1 space-y-4">
        <div className="bg-white dark:bg-[#121f1a] rounded-2xl border border-slate-200/80 dark:border-emerald-900/40 shadow-xs p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-sm text-slate-900 dark:text-emerald-50">Presensi Sarpras</h3>
            </div>
          </div>
      ...
      <div className="lg:col-span-2">
        <div className="bg-white dark:bg-[#121f1a] rounded-2xl border border-slate-200/80 dark:border-emerald-900/40 shadow-xs p-5">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-9 h-9 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 flex items-center justify-center border border-indigo-200/60 dark:border-indigo-800/40 shrink-0">
              <Wrench className="w-4 h-4" />
            </div>
            <div>
              <h3 className="font-bold text-slate-900 dark:text-emerald-50 text-sm">Pemeliharaan &amp; Sarpras</h3>
            </div>
          </div>
